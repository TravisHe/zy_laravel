    ...
    <ul class="nav">
          ...
          <li role="separator" class="divider"></li>
            @if(isset($roles))
              @foreach($roles as $key => $role)
                <li><a href="{{route('admin.users.roles', ['id' => $role->id])}}">{{$role->name}}</a></li>
              @endforeach
            @endif
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li role="separator" class="divider"></li>
          <li><a href="{{route('admin.roles.index')}}">用户身份</a></li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="{{route('admin.products_main.index')}}">所有商品</a></li>
          <li role="separator" class="divider"></li>
          @if(isset($menus))
            @foreach($menus as $key => $menu)
            <li><a href="{{route('admin.products_main.products', ['id' => $menu->id])}}">{{$menu->name}}</a></li>
            @endforeach
          @endif
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          @if(isset($menus))
            @foreach($menus as $key => $menu)
            <li><a href="{{route('admin.products_detail.products', ['id' => $menu->id])}}">{{$menu->name}}</a></li>
            @endforeach
          @endif
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          @if(isset($menus))
            @foreach($menus as $key => $menu)
            <li><a href="{{route('admin.products_media.products', ['id' => $menu->id])}}">{{$menu->name}}</a></li>
            @endforeach
          @endif
        </ul>
      </li>
      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
          <i class="material-icons">fingerprint</i>
            <span>管理权限</span><span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="{{route('admin.admins.index')}}">所有管理员</a></li>
          <li><a href="{{route('admin.jobs.index')}}">管理员职务</a></li>
        </ul>
      </li>
